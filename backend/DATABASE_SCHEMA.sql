/*
  ...
  2. Security
    ...
    - Add policy for reading own donations
...
-- Allow anyone to insert donations (when creating a new donation)
...
-- Allow admin to view all donations (if authenticated as admin)
...
-- Allow backend to update donations
CREATE POLICY "Backend can update donations"
  ON donations
  FOR UPDATE
  TO public
  USING (true)
